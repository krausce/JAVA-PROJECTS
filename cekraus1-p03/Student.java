 ...
 * Class: Student.java																					*
 * DESCRIPTION																							*
 * The Student serves as the baseline class of which all other classes implement elements of type		*	
 * Student as part of the functionality of the program.													*
 * 																										*
...
public class Student implements Comparable<Student> {
	...
	public String toString() {
		String temp = "";
		temp += (getLastName() + " " + getFirstName());
		for (Integer score : this.getExamList()) {
			temp += (" " + score);
		}
		for (Integer score : this.getHomeworkList()) {
			temp += (" " + score);
		}
		return temp;
	}
