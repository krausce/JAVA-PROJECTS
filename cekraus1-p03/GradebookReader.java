 ...
 * DESCRIPTION																							*
 * GradebookReader takes in a String representing the file name to be opened for reading.				*
 * Opens the input file and then reads in each line creating new Student objects and adding them to 	*
 * a Roster which is returned to the caller.
 * 																										*
...
public class GradebookReader  {
    ...
    public Roster readGradebook() {
        ...
        Sorter.sort(roster.getStudentList());
        return roster;
    }
